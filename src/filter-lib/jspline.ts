/* tslint:disable one-variable-per-declaration ban-comma-operator */
/*
 * Monotonic Cubic Spline function, taken from http://blog.mackerron.com/2011/01/01/javascript-cubic-splines/.
 */
...
export default MonotonicCubicSpline;
